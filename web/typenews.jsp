...
<html>
    ...
    <body>
        <%  TypesOfNewsDAOImpl TypesOfNewsDAO = new TypesOfNewsDAOImpl();
            ...
            ArrayList<News> arr = NewsDAO.getListNewsByType(ID_Types_of_news);
            int start = 0, end = 2;
            if (arr.size() < 2) {
                end = arr.size();
                ...
                <div class="col-sm-9">
                    <div class="blog-post-area">
                        ...
                        <ul class="pagination">
                            ...
                            %>
                            <li class="active"><a href="typenews.jsp?ID_Types_of_news=<%=ID_Types_of_news %>&start=<%=a%>&end=<%=b%> "><%=i%></a></li>
                                <% }
                                %>
                        </ul>
